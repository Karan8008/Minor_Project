...
function SecondFloor({ setFloor }: { setFloor: (floor: 'minus1' | 'ground' | 'first' | 'second' | 'third' | 'fourth') => void }) {
  ...
  const rooms: Room[] = [
    { id: 'DBT', name: 'DBT', x: 20, y: 20, width: 100, height: 90, color: '#f3e5f5', door: { position: 'right', offset: 0 } },
    { id: 'lift', name: 'Lift', x: 160, y: 20, width: 50, height: 35, color: '#ede7f6' },
    { id: 'block-1', name: 'PC OFFICE', x: 270, y: 10, width: 118, height: 80, color: '#f3e5f5', door: { position: 'bottom', offset: 0 } },
    { id: 'STAFF ROOM', name: 'VC OFFICE', x: 390, y: 10, width: 118, height: 80, color: '#e3f2fd', door: { position: 'bottom', offset: 0 } },
    ...
    { id: 'space-middle', name: '', x: 250, y: 130, width: 378, height: 120, color: '#e0e0e0' },
    { id: 'corridor-gap2', name: 'Corridor', x: 630, y: 130, width: 48, height: 120, color: '#f5f5f5' },
    { id: 'space-right', name: '', x: 680, y: 130, width: 178, height: 120, color: '#e0e0e0' },
    { id: 'cif', name: 'CIF', x: 10, y: 290, width: 30, height: 90, color: '#e1f5fe', door: [{ position: 'right', offset: -30 }] },
    { id: 'lt3', name: 'TR 7', x: 42, y: 320, width: 58, height: 60, color: '#e1f5fe', door: { position: 'top', offset: 0 } },
    { id: 'TR6', name: 'TR 6', x: 102, y: 320, width: 58, height: 60, color: '#c8e6c9', door: { position: 'top', offset: 0 } },
    { id: 'cr8', name: 'TR 5', x: 162, y: 320, width: 58, height: 60, color: '#c8e6c9', door: { position: 'top', offset: 0 } },
    { id: 'RR', name: 'RR', x: 222, y: 290, width: 30, height: 90, color: '#e0f2f1', door: [{ position: 'left', offset: -30 }] },
    { id: 'GW', name: 'GW', x: 254, y: 310, width: 38, height: 70, color: '#e0f2f1' },
    { id: 'cr7', name: 'ECE LAB 3', x: 294, y: 290, width: 78, height: 90, color: '#c8e6c9', door: { position: 'top', offset: 0 } },
    { id: 'ECE LAB4', name: 'ECE LAB 4', x: 374, y: 290, width: 78, height: 90, color: '#c8e6c9', door: { position: 'top', offset: 0 } },
    { id: 'SRS', name: 'SRS ROOM', x: 454, y: 340, width: 28, height: 40, color: '#c8e6c9', door: { position: 'top', offset: 0 } },
    { id: 'ECE LAB5', name: 'ECE LAB 5', x: 484, y: 290, width: 78, height: 90, color: '#c8e6c9', door: { position: 'top', offset: 0 } },
    { id: 'ECE LAB1', name: 'BIOTECH LAB', x: 564, y: 290, width: 78, height: 90, color: '#c8e6c9', door: { position: 'top', offset: 0 } },
    { id: 'bw', name: 'bw', x: 644, y: 310, width: 38, height: 70, color: '#e0f2f1' },
    { id: 'lab1', name: 'BIOINFO. LAB', x: 684, y: 290, width: 78, height: 90, color: '#ffecb3', door: { position: 'top', offset: 0 } },
    { id: 'server-room', name: 'SR', x: 764, y: 310, width: 30, height: 70, color: '#e0f2f1', door: { position: 'left', offset: 0 } },
    { id: 'cl1', name: 'CL 1', x: 796, y: 240, width: 64, height: 140, color: '#ffecb3', door: { position: 'left', offset: -35 } },
