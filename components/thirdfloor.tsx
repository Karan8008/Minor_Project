...
function ThirdFloor({ setFloor }: { setFloor: (floor: 'minus1' | 'ground' | 'first' | 'second' | 'third' | 'fourth') => void }) {
  ...
  const rooms: Room[] = [
    { id: 'Food Lab', name: 'Food Lab', x: 30, y: 20, width: 80, height: 65, color: '#fff3e0', clickable: true, door: { position: 'top', offset: 0 } },
    { id: 'LIFT', name: 'LIFT', x: 120, y: 20, width: 45, height: 65, color: '#e0e0e0', clickable: false },
    { id: 'Physics Lab2', name: 'Physics Lab2', x: 175, y: 20, width: 110, height: 65, color: '#ede7f6', clickable: true, door: { position: 'top', offset: 0 } },
    { id: 'Robotics Lab', name: 'Robotics Lab', x: 290, y: 20, width: 95, height: 65, color: '#e0f2f1', clickable: true, door: { position: 'top', offset: 0 } },
    { id: 'Server Room Top', name: 'Server Room', x: 390, y: 20, width: 80, height: 65, color: '#f1f8e9', clickable: false },
    { id: 'Mac lab', name: 'Mac lab', x: 475, y: 20, width: 250, height: 65, color: '#fce4ec', clickable: true, door: { position: 'top', offset: 0 } },
    { id: 'ECE Lab-9', name: 'ECE Lab-9', x: 732, y: 20, width: 55, height: 150, color: '#e8eaf6', clickable: true, door: { position: 'top', offset: 0 } },
    { id: 'ECE Lab-8', name: 'ECE Lab-8', x: 792, y: 20, width: 55, height: 150, color: '#e8eaf6', clickable: true, door: { position: 'top', offset: 0 } },
    { id: 'BI project lab', name: 'BI Project Lab', x: 850, y: 20, width: 69, height: 150, color: '#e8eaf6', clickable: true, door: { position: 'top', offset: 0 } },
    ...
    { id: 'Stair-1', name: 'Stair ↓', x: 240, y: 130, width: 50, height: 30, color: '#d4af37', isStair: true, stairDirection: -1, clickable: false },
    { id: 'Stair-2', name: 'Stair ↑', x: 585, y: 130, width: 50, height: 30, color: '#d4af37', isStair: true, stairDirection: 1, clickable: false },
    ...
    { id: 'GD Room', name: 'GD', x: 30, y: 215, width: 17, height: 70, color: '#fff3e0', clickable: true, door: { position: 'top', offset: 0 } },
    { id: 'Language Lab', name: 'Lang Lab', x: 52, y: 215, width: 50, height: 70, color: '#fce4ec', clickable: true, door: { position: 'top', offset: 0 } },
    { id: 'TR-5', name: 'TR-5', x: 107, y: 215, width: 30, height: 70, color: '#ffecb3', clickable: true, door: { position: 'top', offset: 0 } },
    ...
    { id: 'CL6', name: 'CL6', x: 240, y: 215, width: 80, height: 70, color: '#e3f2fd', clickable: true, door: { position: 'top', offset: 0 } },
    { id: 'CL5', name: 'CL5', x: 330, y: 215, width: 80, height: 70, color: '#e3f2fd', clickable: true, door: { position: 'top', offset: 0 } },
    ...
    { id: 'CL4', name: 'CL4', x: 465, y: 215, width: 105, height: 70, color: '#e3f2fd', clickable: true, door: { position: 'top', offset: 0 } },
    { id: 'CL3', name: 'CL3', x: 576, y: 215, width: 105, height: 70, color: '#e3f2fd', clickable: true, door: { position: 'top', offset: 0 } },
  ...
  const isDoorEligibleRoom = (room: Room) => {
    ...
    if (room.isStair || room.isCoridor) return false;
